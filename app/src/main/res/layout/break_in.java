 ...
 */
public class BreakIn extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnTouchListener(mDelayHideTouchListener);

        /* allow user to input texts */
        Button mButton;
        EditText mEdit;
        TextView mText;

        mEdit   = (EditText)findViewById(R.id.userText);
